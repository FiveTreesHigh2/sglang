...
class Envs:
    ...
    # Fused permute+quant A1 path for the SM120 FP8 MoE runner. Verified
    # bitwise-equivalent and faster than the legacy three-kernel path
    # (6.90 -> 6.02 ms/fwd on RTX PRO 5000); enabled by default.
